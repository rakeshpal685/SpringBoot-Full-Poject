...
@Configuration
@EnableWebSecurity // This will create spring security filter chain(debug=true)//to see the logs and filter chain
public class SecurityConfiguration {
 ...
 context looking for the authorized object and hence for every request it needs to be authorized) */
  ...
  in my service and provided my own implementation for the loadUserByUsername method, go and call that
