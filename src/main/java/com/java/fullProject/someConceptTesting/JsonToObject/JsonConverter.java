...
//        or we can use @JsonIgnoreProperties(ignoreUnknown = true) on the top of the converting class.
        //objectMapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);

        //To read the json array from the file and get the output as Array. we will use this when we have
