...
@Table(name = "my_product", //name of the table given by me.
        uniqueConstraints = { //If we want to make a column that must have unique values then we can do it like this.
                @UniqueConstraint(name = "sku_unique",//Here we can give any name.
                        columnNames = "stock_keeping_unit"//This is the name of the column that will have unique values.
                ),
